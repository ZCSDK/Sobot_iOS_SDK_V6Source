...
-(UIButton *)addItemView:(ZCLibRobotSet *) model withX:(CGFloat )x withY:(CGFloat) y withW:(CGFloat) w withH:(CGFloat) h{
    ...
    [itemView setBackgroundImage:[SobotImageTools sobotImageWithColor:[ZCUIKitTools zcgetRobotBtnBgColor]] forState:UIControlStateHighlighted];
    [itemView setBackgroundImage:[SobotImageTools sobotImageWithColor:[ZCUIKitTools zcgetRobotBtnBgColor]] forState:UIControlStateSelected];
    ...
    [itemView setTitleColor:[ZCUIKitTools zcgetRobotBtnBgColor] forState:UIControlStateNormal];

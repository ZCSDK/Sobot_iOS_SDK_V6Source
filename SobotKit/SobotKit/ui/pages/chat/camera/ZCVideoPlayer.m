...
-(void)showControlsView{
    ...
    [_btnBack setImage:SobotKitGetImage(@"icon_video_close") forState:0];
    ...
    [_btnPlay setImage:SobotKitGetImage(@"zcicon_video_fullplay") forState:0];
    ...
    _menuView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.frame) - 52 - XBottomBarHeight, CGRectGetMaxX(self.frame), 52)];
    ...
    [_btnPause setImage:SobotKitGetImage(@"icon_video_menu_pause") forState:0];
    ...
    [_labStartTime setTextColor:UIColorFromModeColor(SobotColorWhite)];
    ...
    [_labEndTime setTextColor:UIColorFromModeColor(SobotColorWhite)];
    ...
    _sliderProgress.tintColor = UIColorFromModeColor(SobotColorWhite);
    ...
    UIImage *img = [SobotImageTools sobotImageWithColor:UIColorFromModeColor(SobotColorWhite)];
...
-(void)pause:(UIButton *) btn{
    if(self.player){
        if (self.player.rate == 0) {
            ...
            if(_btnPlay){
                _btnPlay.hidden = NO;
                [_btnPause setImage:SobotKitGetImage(@"icon_video_menu_play") forState:0];
            }
        }
    }
}

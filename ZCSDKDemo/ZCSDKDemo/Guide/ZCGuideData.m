...
-(void)setDefaultValue{
    ...
    #pragma mark - 环境
            NSString *apiHost = @"https://www.sobot.com";
...
//            @{@"index":@(ZCSectionIndex353),@"code":@"3.5.3",@"name":@"读取日志",@"desc":@"本地日志查询",@"extends":@""}
        ...
        [_configItems setObject:@[
            @{@"index":@(ZCConfigIndex31),@"code":@"3.1",@"name":@"设置域名",@"desc":@"不设置默认为https://api.sobot.com，腾讯云为https://www.soboten.com，其它根据自己服务配置域名",@"extends":@"",@"key":@"api_host",@"type":@"NSString",@"from":@(ZCConfigFromClient)},
        ...
        [_configItems setObject:@[
         ...
         @{@"index":@(ZCConfigIndex414),@"code":@"4.1.5",@"name":@"给机器人发送一条消息",@"desc":@"消息类型",@"extends":@"",@"key":@"content",@"type":@"NSString",@"from":@(ZCConfigFromLibInit)},
            @{@"index":@(ZCConfigIndex414),@"code":@"4.1.6",@"name":@"指定机器人引导语",@"desc":@"不同的场景可以设置不同的机器人引导语",@"extends":@"",@"key":@"faqId",@"type":@"NSString",@"from":@(ZCConfigFromLibInit)}
        ] forKey:@"4.1"];
        ...
        [_configItems setObject:@[
            ...
            @{@"index":@(ZCConfigIndex45),@"code":@"4.6",@"name":@"帮助中心电话",@"desc":@"帮助中心电话显示内容",@"extends":@"",@"key":@"helpCenterTelTitle",@"type":@"NSString",@"from":@(ZCConfigFromKit)},
            @{@"index":@(ZCConfigIndex45),@"code":@"4.6",@"name":@"帮助中心电话",@"desc":@"帮助中心电话号码",@"extends":@"",@"key":@"helpCenterTel",@"type":@"NSString",@"from":@(ZCConfigFromKit)}
        ] forKey:@"4.6"];

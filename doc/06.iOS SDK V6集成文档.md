...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-0.png)

相关限制及注意事项  
1、iOS SDK新版支持 iOS10 以上版本，同时支持 iPhone、iPad，支持竖屏和横屏。
...
## 1.2.文件说明
**SDK包含（SobotKit.framework、SobotCommon.framework、SobotChatClient.framework和SobotKit.bundle）、SobotDemo、和Doc相关说明文档。**

| 文件名   | 说明   |备注|
|:----|:----|:----|
| SobotKit.framework   | 智齿SDK UI 代码库   |    |
| SobotCommon.framework   | 智齿SDK基础代码库   |    |
| SobotChatClient.framework   | 智齿SDK接口代码库   |    |
| SobotKit.bundle   | SDK资源库，包含图片文件、多语言文件、颜色   |    |
| ZCSobotApi.h   | 该文件提供接入功能   |    |
...
下载链接：[iOS_SDK_4.0.0](https://img.sobot.com/mobile/sdk/iOS_SDK_4.0.0.zip)

电商版：

下载链接：[iOS_SDK_4.0.0_电商版](https://img.sobot.com/mobile/sdk/iOS_SDK_4.0.0_MALL.zip)

解压[iOS_SDK]，添加必要文件SobotKit.framework、SobotChatClient.framework、SobotCommon.framework和SobotKit.bundle到你的工程里。智齿iOS_SDK 的实现，依赖了一些系统的框架，在开发应用时需要在工程里加入这些框架。开发者首先点击工程右边的工程名，然后在工程名右边依次选择TARGETS -> BuiLd Phases -> Link Binary With Libraries，展开 LinkBinary With Libraries后点击展开后下面的 + 来添加下面的依赖项:
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-3-2.png)
...
//        if ([linkUrl hasPrefix:@"www."]) {  // 测试调试 跳转根vc使用
...
```
效果如图：
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-3-5.png)
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-1-1.png)
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-2-1.png)
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-2-2.png)

![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-2-2-1.png)
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-2-3.png)
...
效果图如下：
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-2-3-1.png)
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-2-6.png)
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-2-6-1.png)
...
```
效果图：
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-2-8.png)
...
```
效果图：
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-2-9.png)
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-3-1.png)
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-3-2.png)
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-4-1.png)
...
![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-4-2.png)![图片](https://img.sobot.com/mobile/sdk/new/images/v6/a-4-4-2-1.png)
...
## 8 更新说明
   ...
   [《智齿iOS_SDK 版本更新说明》](https://shimo.im/docs/dPkpKPglrxtW7oqO/)
